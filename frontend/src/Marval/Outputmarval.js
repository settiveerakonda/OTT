          ...
          <Slider {...settings}>
            {data.map((ele, i) => (
              <div className="col-12 col-sm-6 col-md-3" key={i}>
                <div className="OutputMarval-wrapper">
                  <div className="portrait-container">
                    
                        <div className="OutputMarval-image-content">
                          <div className="image-OutputMarval portrait-img base-OutputMarval-image">
                            <img 
